...
namespace patyy.Controllers
{
    public class EstadoesController : Controller
    {
        ...
        public EstadoesController(ProyectoFinalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstado")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstado")] Estado estado)
        {
